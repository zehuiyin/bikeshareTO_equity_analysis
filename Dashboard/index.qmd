...
[![](./Graphs/Suitability.png){width="100%"}](./Graphs/delta_results.png)
:::
...
::: {layout-ncol=4}
![**Black Residents  (Weight=0.06)**](./Graphs/black_hotspots.jpg)

![**Chinese Residents (Weight=0.03)**](./Graphs/chinese_hotspots.jpg)

![**Female Residents (Weight=0.02)**](./Graphs/female_hotspots.jpg)

![**Indigenous Residents (Weight=0.55)**](./Graphs/indigenous_hotspots.jpg)

![**Latino Residents (Weight=0.13)**](./Graphs/latino_hotspots.jpg)

![**Low Income Residents (Weight=0.04)**](./Graphs/low-income_hotspots.jpg)

![**$\approx1km$ Buffer around Existing Equitable Catchment Areas**](./Graphs/buffer.png)
:::
