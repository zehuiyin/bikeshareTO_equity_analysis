...
Our analysis is subject to two primary constraints: 1\) Due to the unavailability of historical data for bike share stations, our study is based on real-time station data. 2\) The delineation of non-overlapping catchment areas was performed using Euclidean distance. While this method provides a general overview, it does not account for the actual travel distance along the road network, which could offer a more precise representation.
